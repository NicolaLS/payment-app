...
| P0.3 Freeze gate | IN PROGRESS | Local `papp-final` signed tag and `papp-legacy` branch point to `6e57bfd`; publish and protect the references. |
| Milestone 1 — RAYL skeleton | IN PROGRESS | Repository/topology audit is underway on `codex/rayl-blip-extraction`. |
| Milestone 2 — Blip extraction | NOT STARTED | Begins after the skeleton and root move are complete. |
