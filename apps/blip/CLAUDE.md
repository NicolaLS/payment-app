...
Blip is a Kotlin Multiplatform (KMP) Lightning payment app targeting Android and iOS. It uses Compose Multiplatform for the UI and connects to Lightning wallets via Nostr Wallet Connect (NWC) and Blink API wallets.
