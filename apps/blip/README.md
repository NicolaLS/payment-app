...
Blip currently supports one connected wallet at a time, either Blink or NWC. Earlier
...
The debug app installs as `xyz.lilsus.blip.dev`, separate from the release app.
