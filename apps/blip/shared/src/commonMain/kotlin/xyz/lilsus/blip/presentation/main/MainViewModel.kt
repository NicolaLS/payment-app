...
import xyz.lilsus.blip.presentation.main.contacts.ContactEditorUiState
import xyz.lilsus.blip.presentation.main.contacts.ContactListItem
import xyz.lilsus.blip.presentation.main.contacts.ContactSavePromptUiState
...
import xyz.lilsus.blip.presentation.main.contacts.ShortcutListItem
...
private sealed class PendingRetryContinuation {
    ...
    data class LightningAddress(
        val address: xyz.lilsus.blip.domain.lnurl.LightningAddress,
        val sourceKey: String,
        val paymentSource: PaymentRequestSource
    ) : PendingRetryContinuation()
}
