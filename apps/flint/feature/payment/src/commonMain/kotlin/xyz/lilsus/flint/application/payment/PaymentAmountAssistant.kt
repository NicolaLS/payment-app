...
interface PaymentAmountAssistant {
    ...
    suspend fun updateCurrencyPreferences(
        preferences: PaymentCurrencyPreferences
    ): UpdateCurrencyPreferencesResult
...
object UnavailablePaymentAmountAssistant : PaymentAmountAssistant {
    ...
    override suspend fun updateCurrencyPreferences(preferences: PaymentCurrencyPreferences) =
        UpdateCurrencyPreferencesResult.STORAGE_FAILURE
...
enum class UpdateCurrencyPreferencesResult {
    UPDATED,
    STORAGE_FAILURE
}

sealed interface LoadCurrencyPreferencesResult {
    data class Available(val preferences: PaymentCurrencyPreferences) :
        LoadCurrencyPreferencesResult
    data object StorageFailure : LoadCurrencyPreferencesResult
}

interface PaymentCurrencyPreferenceRepository {
    fun load(): LoadCurrencyPreferencesResult
    fun store(preferences: PaymentCurrencyPreferences): Boolean
}

object DefaultPaymentCurrencyPreferenceRepository : PaymentCurrencyPreferenceRepository {
    override fun load() =
        LoadCurrencyPreferencesResult.Available(PaymentCurrencyPreferences.Default)
    override fun store(preferences: PaymentCurrencyPreferences) = true
}
