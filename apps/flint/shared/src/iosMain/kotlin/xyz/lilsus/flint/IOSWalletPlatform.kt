...
package xyz.lilsus.flint.data.platform
...
import xyz.lilsus.flint.application.wallet.WalletBoundActivityCleaner
import xyz.lilsus.flint.application.wallet.WalletCredential
import xyz.lilsus.flint.application.wallet.WalletDirectories
import xyz.lilsus.flint.data.breez.BreezSparkSdkConnector
import xyz.lilsus.flint.data.database.SqlPaymentAttemptRepository
import xyz.lilsus.flint.data.database.SqlPaymentCurrencyPreferenceRepository
import xyz.lilsus.flint.data.database.SqlPaymentPolicyRepository
...
fun createIOSAppRuntime(bootstrapConfig: AppBootstrapConfig): AppRuntime {
    ...
    val paymentEngine = DefaultPaymentEngine(
        ...
        policyRepository = SqlPaymentPolicyRepository(driver),
        currencyPreferenceRepository = SqlPaymentCurrencyPreferenceRepository(driver),
    ...
    val walletAccess = DefaultWalletAccess(
        ...
        activityCleaner = WalletBoundActivityCleaner(paymentEngine::clearWalletData),
        applicationScope = applicationScope
