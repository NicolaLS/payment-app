...
suspend fun nativeLasrOnboardingText(): NativeLasrOnboardingText = NativeLasrOnboardingText(
    ...
    welcomeSubtitle = nativeString(
        NativeStringResource(table = "LasrOnboarding", key = "onboarding_welcome_subtitle_line1")
    ),
    welcomeDescription = nativeString(
        NativeStringResource(table = "LasrOnboarding", key = "onboarding_welcome_subtitle_line2")
    ),
    featurePages =
        listOf(
    ...
    instructionSteps =
        listOf(
            nativeString(
                NativeStringResource(table = "LasrOnboarding", key = "onboarding_add_wallet_step1")
            ),
            nativeString(
                NativeStringResource(table = "LasrOnboarding", key = "onboarding_add_wallet_step2")
            ),
            nativeString(
                NativeStringResource(table = "LasrOnboarding", key = "onboarding_add_wallet_step3")
            )
        )
)
