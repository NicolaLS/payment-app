...
import xyz.lilsus.lasr.feature.payment.amount.RangeStatus
import xyz.lilsus.lasr.feature.payment.generated.resources.Res
import xyz.lilsus.lasr.feature.payment.generated.resources.enter_amount_range_max
import xyz.lilsus.lasr.feature.payment.generated.resources.enter_amount_range_min
import xyz.lilsus.lasr.feature.payment.generated.resources.enter_amount_title
import xyz.lilsus.lasr.feature.payment.generated.resources.pay_button
...
fun ManualAmountBottomSheet(
    ...
    ModalBottomSheet(
        ...
        Column(
            modifier = Modifier
                .fillMaxWidth()
                .testTag(PaymentTestTags.MANUAL_AMOUNT_SHEET)
...
private fun AmountInputDisplay(state: ManualAmountUiState) {
    ...
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .testTag(PaymentTestTags.MANUAL_AMOUNT_DISPLAY),
...
private fun ManualAmountKey.testTag(): String = when (this) {
    is ManualAmountKey.Digit -> PaymentTestTags.manualAmountDigitKey(value)
    ManualAmountKey.Decimal -> PaymentTestTags.MANUAL_AMOUNT_DECIMAL_KEY
    ManualAmountKey.Backspace -> PaymentTestTags.MANUAL_AMOUNT_BACKSPACE_KEY
}
