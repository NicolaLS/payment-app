...
object RepeatPaymentTestTags {
    ...
    const val CREATE_ADDITIONAL_PAYMENT_BUTTON =
        "payment_intent_create_additional_payment_button"
    const val VIEW_PREVIOUS_PAYMENT_BUTTON =
        "payment_intent_view_previous_payment_button"
}
