...
import xyz.lilsus.raylsuite.feature.payment.components.SessionTransactionsScreen
...
import xyz.lilsus.raylsuite.feature.payment.generated.resources.tap_dismiss_pending
import xyz.lilsus.raylsuite.feature.payment.generated.resources.toast_bitcoin_address
import xyz.lilsus.raylsuite.feature.payment.generated.resources.toast_bolt12_not_supported
...
private fun SessionTransactionItem.toDetailUiState(): PaymentUiState = when (status) {
    PendingStatus.Waiting -> PaymentUiState.Loading()
