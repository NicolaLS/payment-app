    ...
    nativeHubView: {
        AnyView(
            NativePaymentHubView(
                controller: experience.hubController(),
                importButton: AnyView(
                    BlipContactsImportLink(
                        controller: experience.contactsController()
                    )
                )
            )
        )
    ...
    nativeOnboardingView: {
        AnyView(
            BlipNativeOnboardingView(
                controller: experience.onboardingController(),
                contactsController: experience.contactsController()
            )
        )
    }
)
